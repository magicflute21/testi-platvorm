...
- `docs/tasks/backend/` — backendi taskide failid: Balsamiq märkmed (`<Vaade>-markmed.md`), backend taskid, implementatsiooniplaanid (`*-IMPLEMENTATSIOON.md`), backendi projekti struktuur (`projekti-struktuur.md`) ja rAIn juhendid (`instructions/`)
